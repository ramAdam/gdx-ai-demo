...
public class ParallelVsSequenceTest extends BehaviorTreeTestBase {
	...
	static class TestScreen extends ScreenAdapter {
		...
		public TestScreen (final ParallelVsSequenceTest test, Skin skin) {
			...
			greenFishTextureRegion = new TextureRegion(new Texture("green_fish.png"));
			badlogicTextureRegion = new TextureRegion(new Texture("badlogicsmall.jpg"));
			targetTextureRegion = new TextureRegion(new Texture("target.png"));
