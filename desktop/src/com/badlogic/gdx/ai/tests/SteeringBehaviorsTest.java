...
public class SteeringBehaviorsTest extends ApplicationAdapter {
	...
	public void create () {
		...
		greenFish = new TextureRegion(new Texture("green_fish.png"));
		cloud = new TextureRegion(new Texture("particle-cloud.png"));
		badlogicSmall = new TextureRegion(new Texture("badlogicsmall.jpg"));
		target = new TextureRegion(new Texture("target.png"));
